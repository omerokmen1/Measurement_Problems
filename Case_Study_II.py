...
# etkileyeceğinden dolayı bu durum hem maddi kayıplara hem de müşteri kayıplarına neden olabilir. Bu 2 temel problemin
# çözümüyle birlikte e-ticaret sitesi ve satıcılar satışlarını arttırırken; müşteriler ise satın alma yolculuğunu
# sorunsuz olarak tamamlayacaktır.
...
# Bu görevde amacımız verilen puanları tarihe göre ağırlıklandırarak değerlendirmektir.
...
df = pd.read_csv("Measurement Problems/amazon_review.csv", low_memory=False)
df["overall"].mean()
...
# Veri setinde helpful_no değişkeni olmadığı için var olan değişkenler üzerinden üretilmesi gerekmektedir.
...
def wilson_lower_bound(up, down, confidence=0.95):
    ...
    - Not: Eğer skorlar 1-5 arasındaysa 1-3 negatif, 4-5 pozitif olarak işaretlenir ve bernoulli'ye uygun hale getirilebilir.
