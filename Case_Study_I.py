...
# reklam sayıları gibi bilgilerin yanı sıra buradan gelen kazanç bilgileri de yer almaktadır. Kontrol ve Test
...
dataframe_control = pd.read_excel("Measurement Problems/ab_testing.xlsx", sheet_name="Control Group")
dataframe_test = pd.read_excel("Measurement Problems/ab_testing.xlsx", sheet_name="Test Group")
...
# Varsayım kontrolü şu iki adımdan oluşur: Normallik Varsayımı ve Varyans Homojenliği.
...
print('Test Stat = %.4f, p-value = %.4f' % (test_stat, pvalue))
# p-value=0.1083
# HO reddedilemez. Control ve Test grubunun değerleri varyans homejenliği varsayımını da sağlamaktadır.
# Varyanslar Homojendir.

# Adım 2: Normallik Varsayımı ve Varyans Homojenliği sonuçlarına göre uygun testi seçiniz

# Varsayımlar sağlandığı için BAĞIMSIZ İKİ ÖRNEKLEM T TESTİ (PARAMETRİK TEST) yapılmaktadır.
# H0: M1 = M2 (Kontrol grubu ve test grubu satın alma ortalamaları arasında istatistiki olarak anlamlı fark yoktur.)
# H1: M1 != M2 (Kontrol grubu ve test grubu satın alma ortalamaları arasında istatistiki olarak anlamlı fark vardır.)
